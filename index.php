            	...
            	<div class="authSection onyxBg clearfix">
                	<div class="col-md-12">
                    	<ul class="nav nav-pills nav-justified">
                          <li><a href="#signup" aria-controls="signup" role="pill" data-toggle="pill" class="btn btn-default fs16 f600 btn-tab">Sign Up</a></li>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane whiteFg" id="signup">
                            	...
                            	<form action="index.php" method="post" class="signup-form">
                                	  <div class="form-group">
                                        ...
                                        <input type="email" class="form-control onyxBg bRad0" id="" placeholder="Full Name *">
                                      </div>
                                	  <div class="form-group">
                                        <label for="" class="f600">Email address</label>
                                        <input type="email" class="form-control onyxBg bRad0" id="" placeholder="Email *">
                                      </div>
                                      <div class="form-group">
                                        <label for="" class="f600">Password</label>
                                        <input type="password" class="form-control onyxBg bRad0" id="" placeholder="Password *">
                                      </div>
                                      <div class="form-group">
